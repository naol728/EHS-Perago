...
export default function AddEmploye() {
  return (
    <div className="flex h-[90vh]  justify-center items-center ">
      <div className="grid place-content-center max-w-xl space-y-5 h-full px-16 rounded-xl  bg-light-background dark:bg-dark-background text-light-text dark:text-dark-text ">
        <h2 className="text-2xl font-semibold text-center mb-4">Add Employe</h2>
